...
def init_key_manager():
    ...
    try:
        ...
        logger.error(f"Ошибка инициализации key_manager: {e}")
        raise
...
def get_subscription(signed_id):
    ...
    # Инициализируем key_manager если еще не инициализирован
    ...
    try:
        ...
        logger.info(f"Возвращаем RAW .sub (vless) для пользователя {user_id}")
